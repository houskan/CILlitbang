...
from tf_aerial_images_submission import create_submission
...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    test_dir = '../../../data/test/'
    test_data_filename = test_dir + 'images/'
    ...
    def predict_file(path, filename):
    ...
    with tf.Session() as s:
        ...
        for f in os.listdir(test_data_filename):
            print("Predicting %s" % f)
            pimg = predict_file(test_data_filename, f)
            Image.fromarray(img_float_to_uint8(pimg)).save(prediction_test_dir + f)
